...
<div id="carousel-example-generic" class="carousel slide <?php echo $slider_setting['slider_options']; ?>"data-ride="carousel" 
	...
	<!-- Indicators -->
		...
		<div class="item active">
		   <img src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/slide/slide1.png">
			<div class="container slide-caption">
				<div class="slide-text-bg1"><h2><?php _e('Laboratarios','UCR'); ?></h2></div>
				<div class="slide-text-bg2"><span><?php _e('Bienvenidos a ITM tenemos toda la info que necesitas','appointment'); ?></span></div>	
				<div class="slide-btn-area-sm"><a href="#" class="slide-btn-sm"><?php _e('Read More','appointment'); ?></a></div>		
			</div>
		</div>  
		<div class="item">
		   <img src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/slide/slide3.png">
			<div class="container slide-caption">
				<div class="slide-text-bg1"><h2><?php _e('Expomedia','appointment'); ?></h2></div>
				<div class="slide-text-bg2"><span><?php _e('Stands, Talleres y Charlas de la semana mas emocionante de ITM','appointment'); ?></span></div>	
				<div class="slide-btn-area-sm"><a href="#" class="slide-btn-sm"><?php _e('Read More','appointment'); ?></a></div>		
			</div>
		</div>
		<div class="item">
		  <img src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/slide/slide2.png">
			<div class="container slide-caption">
				<div class="slide-text-bg1"><h2><?php _e('Instalaciones de ITM','appointment'); ?></h2></div>
				<div class="slide-text-bg2"><span><?php _e('Tenemos excelentes instalaciones, acopladas a las necesidades de los estudiantes.','appointment'); ?></span></div>	
				<div class="slide-btn-area-sm"><a href="#" class="slide-btn-sm"><?php _e('Read More','appointment'); ?></a></div>		
			</div>	
		</div>
		</div>  
